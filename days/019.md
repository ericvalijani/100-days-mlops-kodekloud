...
2. Add remaining two stage:
    ...
    > We have added two missing stages. Full source code of day 19 [dvc.yaml](../files/day_19_dvc.yaml)
...
Clone the the full project and follow the [guidelines](../ml-pipeline/README.md) to test the `ml-pipeline` full dvc pipeline locally.
